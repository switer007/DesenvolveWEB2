                    ...
                    <h2>Usuários Cadastrados</h2>
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $usuarios = mysql_query($conexao, $sql);
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="editarUsuairio.php?idUsuario=<?= $usuario['idUsuario']?>" class="btn btn-success btn-sm">Editar</a>
                                        <form action="frmApagarUsuario.php" method="post">
                                            <button onclick="return confirm('Tem certeza que deseja excluir?')" type="submit" name="apagarUsuario" value="" class="btn btn-danger btn-sm">Excluir</button>
                                        </form>
                                    </td>
                                </tr>
                                <?php 
